...
architecture behav of image_filter_AXIvideo2Mat is 
    ...
    signal tmp_3_fu_348_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_3_reg_419 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_4_reg_424 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp1_stg0_fsm_4) and (exitcond2_fu_315_p2 = ap_const_lv1_0) and not(((ap_sig_bdd_116 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it0)) or (ap_sig_bdd_126 and (ap_const_logic_1 = ap_reg_ppiten_pp1_it1)))))) then
                tmp_3_reg_419 <= tmp_3_fu_348_p1;
                tmp_4_reg_424 <= p_Val2_s_phi_fu_230_p4(15 downto 8);
            end if;
        end if;
    end process;
    ...
    img_data_stream_0_V_din <= tmp_3_reg_419;
    ...
    img_data_stream_1_V_din <= tmp_4_reg_424;
    ...
    tmp_3_fu_348_p1 <= p_Val2_s_phi_fu_230_p4(8 - 1 downto 0);
