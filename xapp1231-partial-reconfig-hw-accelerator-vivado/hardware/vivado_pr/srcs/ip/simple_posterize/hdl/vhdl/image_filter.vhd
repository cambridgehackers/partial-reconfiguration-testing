...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.433000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=502,HLS_SYN_LUT=874}";
    ...
    signal image_filter_Block_proc_U0_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Block_proc_U0_cols_out_full_n : STD_LOGIC;
    signal image_filter_Block_proc_U0_cols_out_write : STD_LOGIC;
    signal image_filter_Block_proc_U0_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Block_proc_U0_rows_out_full_n : STD_LOGIC;
    signal image_filter_Block_proc_U0_rows_out_write : STD_LOGIC;
    ...
    signal image_filter_Loop_1_proc_U0_ap_start : STD_LOGIC := '0';
    ...
    signal image_filter_Loop_1_proc_U0_rows_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Loop_1_proc_U0_rows_empty_n : STD_LOGIC;
    signal image_filter_Loop_1_proc_U0_rows_read : STD_LOGIC;
    signal image_filter_Loop_1_proc_U0_cols_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal image_filter_Loop_1_proc_U0_cols_empty_n : STD_LOGIC;
    signal image_filter_Loop_1_proc_U0_cols_read : STD_LOGIC;
    ...
    signal cols36_channel_U_ap_dummy_ce : STD_LOGIC;
    signal cols36_channel_din : STD_LOGIC_VECTOR (31 downto 0);
    signal cols36_channel_full_n : STD_LOGIC;
    signal cols36_channel_write : STD_LOGIC;
    signal cols36_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal cols36_channel_empty_n : STD_LOGIC;
    signal cols36_channel_read : STD_LOGIC;
    signal rows37_channel_U_ap_dummy_ce : STD_LOGIC;
    signal rows37_channel_din : STD_LOGIC_VECTOR (31 downto 0);
    signal rows37_channel_full_n : STD_LOGIC;
    signal rows37_channel_write : STD_LOGIC;
    signal rows37_channel_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal rows37_channel_empty_n : STD_LOGIC;
    signal rows37_channel_read : STD_LOGIC;
    ...
    component FIFO_image_filter_cols36_channel IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component FIFO_image_filter_rows37_channel IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        cols_out_din => image_filter_Block_proc_U0_cols_out_din,
        cols_out_full_n => image_filter_Block_proc_U0_cols_out_full_n,
        cols_out_write => image_filter_Block_proc_U0_cols_out_write,
        rows_out_din => image_filter_Block_proc_U0_rows_out_din,
        rows_out_full_n => image_filter_Block_proc_U0_rows_out_full_n,
        rows_out_write => image_filter_Block_proc_U0_rows_out_write,
    ...
    port map (
        ...
        rows_dout => image_filter_Loop_1_proc_U0_rows_dout,
        rows_empty_n => image_filter_Loop_1_proc_U0_rows_empty_n,
        rows_read => image_filter_Loop_1_proc_U0_rows_read,
        cols_dout => image_filter_Loop_1_proc_U0_cols_dout,
        cols_empty_n => image_filter_Loop_1_proc_U0_cols_empty_n,
        cols_read => image_filter_Loop_1_proc_U0_cols_read,
    ...
    cols36_channel_U : component FIFO_image_filter_cols36_channel
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => cols36_channel_U_ap_dummy_ce,
        if_write_ce => cols36_channel_U_ap_dummy_ce,
        if_din => cols36_channel_din,
        if_full_n => cols36_channel_full_n,
        if_write => cols36_channel_write,
        if_dout => cols36_channel_dout,
        if_empty_n => cols36_channel_empty_n,
        if_read => cols36_channel_read);

    rows37_channel_U : component FIFO_image_filter_rows37_channel
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => rows37_channel_U_ap_dummy_ce,
        if_write_ce => rows37_channel_U_ap_dummy_ce,
        if_din => rows37_channel_din,
        if_full_n => rows37_channel_full_n,
        if_write => rows37_channel_write,
        if_dout => rows37_channel_dout,
        if_empty_n => rows37_channel_empty_n,
        if_read => rows37_channel_read);
    ...
    -- image_filter_Loop_1_proc_U0_ap_start assign process. --
    image_filter_Loop_1_proc_U0_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                image_filter_Loop_1_proc_U0_ap_start <= ap_const_logic_0;
            else
                image_filter_Loop_1_proc_U0_ap_start <= ap_const_logic_1;
            end if;
        end if;
    end process;
    ...
    begin
        if (((ap_const_logic_1 = image_filter_Block_proc_U0_ap_idle) and (ap_const_logic_1 = image_filter_AXIvideo2Mat_U0_ap_idle) and (ap_const_logic_1 = image_filter_Loop_1_proc_U0_ap_idle) and (ap_const_logic_1 = image_filter_Mat2AXIvideo_U0_ap_idle) and (ap_const_logic_0 = img_0_rows_V_channel_empty_n) and (ap_const_logic_0 = img_0_cols_V_channel_empty_n) and (ap_const_logic_0 = img_1_rows_V_empty_n) and (ap_const_logic_0 = img_1_cols_V_empty_n))) then 
    ...
    begin
        if ((ap_reg_ready_img_1_cols_V_full_n = ap_const_logic_0)) then 
    ...
    cols36_channel_U_ap_dummy_ce <= ap_const_logic_1;
    cols36_channel_din <= image_filter_Block_proc_U0_cols_out_din;
    cols36_channel_read <= image_filter_Loop_1_proc_U0_cols_read;
    cols36_channel_write <= image_filter_Block_proc_U0_cols_out_write;
    ...
    image_filter_Block_proc_U0_ap_continue_assign_proc : process(ap_sig_ready_img_1_cols_V_full_n, ap_sig_ready_img_0_cols_V_channel_full_n, ap_sig_ready_img_0_rows_V_channel_full_n, ap_sig_ready_img_1_rows_V_full_n)
    begin
        if (((ap_const_logic_1 = ap_sig_ready_img_1_cols_V_full_n) and (ap_const_logic_1 = ap_sig_ready_img_0_cols_V_channel_full_n) and (ap_const_logic_1 = ap_sig_ready_img_0_rows_V_channel_full_n) and (ap_const_logic_1 = ap_sig_ready_img_1_rows_V_full_n))) then 
    ...
    image_filter_Block_proc_U0_cols_out_full_n <= cols36_channel_full_n;
    image_filter_Block_proc_U0_rows <= rows;
    image_filter_Block_proc_U0_rows_out_full_n <= rows37_channel_full_n;
    image_filter_CONTROL_BUS_s_axi_U_ap_dummy_ce <= ap_const_logic_1;
    image_filter_Loop_1_proc_U0_ap_continue <= ap_const_logic_1;
    image_filter_Loop_1_proc_U0_cols_dout <= cols36_channel_dout;
    image_filter_Loop_1_proc_U0_cols_empty_n <= cols36_channel_empty_n;
    ...
    image_filter_Loop_1_proc_U0_rows_dout <= rows37_channel_dout;
    image_filter_Loop_1_proc_U0_rows_empty_n <= rows37_channel_empty_n;
    ...
    rows37_channel_U_ap_dummy_ce <= ap_const_logic_1;
    rows37_channel_din <= image_filter_Block_proc_U0_rows_out_din;
    rows37_channel_read <= image_filter_Loop_1_proc_U0_rows_read;
    rows37_channel_write <= image_filter_Block_proc_U0_rows_out_write;
    video_in_TREADY <= image_filter_AXIvideo2Mat_U0_video_in_TREADY;
    video_out_TDATA <= image_filter_Mat2AXIvideo_U0_video_out_TDATA;
    video_out_TDEST <= image_filter_Mat2AXIvideo_U0_video_out_TDEST;
    video_out_TID <= image_filter_Mat2AXIvideo_U0_video_out_TID;
