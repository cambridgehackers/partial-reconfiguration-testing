...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2014_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.433000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=502,HLS_SYN_LUT=874}" *)
...
wire   [31:0] image_filter_Block_proc_U0_cols_out_din;
wire    image_filter_Block_proc_U0_cols_out_full_n;
wire    image_filter_Block_proc_U0_cols_out_write;
wire   [31:0] image_filter_Block_proc_U0_rows_out_din;
wire    image_filter_Block_proc_U0_rows_out_full_n;
wire    image_filter_Block_proc_U0_rows_out_write;
...
reg    image_filter_Loop_1_proc_U0_ap_start = 1'b0;
...
wire   [31:0] image_filter_Loop_1_proc_U0_rows_dout;
wire    image_filter_Loop_1_proc_U0_rows_empty_n;
wire    image_filter_Loop_1_proc_U0_rows_read;
wire   [31:0] image_filter_Loop_1_proc_U0_cols_dout;
wire    image_filter_Loop_1_proc_U0_cols_empty_n;
wire    image_filter_Loop_1_proc_U0_cols_read;
...
wire    cols36_channel_U_ap_dummy_ce;
wire   [31:0] cols36_channel_din;
wire    cols36_channel_full_n;
wire    cols36_channel_write;
wire   [31:0] cols36_channel_dout;
wire    cols36_channel_empty_n;
wire    cols36_channel_read;
wire    rows37_channel_U_ap_dummy_ce;
wire   [31:0] rows37_channel_din;
wire    rows37_channel_full_n;
wire    rows37_channel_write;
wire   [31:0] rows37_channel_dout;
wire    rows37_channel_empty_n;
wire    rows37_channel_read;
...
FIFO_image_filter_cols36_channel cols36_channel_U(
    .clk( ap_clk ),
    .reset( ap_rst_n_inv ),
...
FIFO_image_filter_rows37_channel rows37_channel_U(
    .clk( ap_clk ),
    .reset( ap_rst_n_inv ),
...
always @ (posedge ap_clk)
begin : ap_ret_image_filter_Loop_1_proc_U0_ap_start
    if (ap_rst_n_inv == 1'b1) begin
...
begin
    if (((ap_const_logic_1 == image_filter_Block_proc_U0_ap_idle) & (ap_const_logic_1 == image_filter_AXIvideo2Mat_U0_ap_idle) & (ap_const_logic_1 == image_filter_Loop_1_proc_U0_ap_idle) & (ap_const_logic_1 == image_filter_Mat2AXIvideo_U0_ap_idle) & (ap_const_logic_0 == img_0_rows_V_channel_empty_n) & (ap_const_logic_0 == img_0_cols_V_channel_empty_n) & (ap_const_logic_0 == img_1_rows_V_empty_n) & (ap_const_logic_0 == img_1_cols_V_empty_n))) begin
...
begin
    if ((ap_reg_ready_img_1_cols_V_full_n == ap_const_logic_0)) begin
...
always @ (ap_sig_ready_img_1_cols_V_full_n or ap_sig_ready_img_0_cols_V_channel_full_n or ap_sig_ready_img_0_rows_V_channel_full_n or ap_sig_ready_img_1_rows_V_full_n)
begin
    if (((ap_const_logic_1 == ap_sig_ready_img_1_cols_V_full_n) & (ap_const_logic_1 == ap_sig_ready_img_0_cols_V_channel_full_n) & (ap_const_logic_1 == ap_sig_ready_img_0_rows_V_channel_full_n) & (ap_const_logic_1 == ap_sig_ready_img_1_rows_V_full_n))) begin
...
assign cols36_channel_U_ap_dummy_ce = ap_const_logic_1;
assign cols36_channel_din = image_filter_Block_proc_U0_cols_out_din;
assign cols36_channel_read = image_filter_Loop_1_proc_U0_cols_read;
assign cols36_channel_write = image_filter_Block_proc_U0_cols_out_write;
...
assign image_filter_Block_proc_U0_cols_out_full_n = cols36_channel_full_n;
assign image_filter_Block_proc_U0_rows = rows;
assign image_filter_Block_proc_U0_rows_out_full_n = rows37_channel_full_n;
...
assign image_filter_Loop_1_proc_U0_cols_dout = cols36_channel_dout;
assign image_filter_Loop_1_proc_U0_cols_empty_n = cols36_channel_empty_n;
...
assign image_filter_Loop_1_proc_U0_rows_dout = rows37_channel_dout;
assign image_filter_Loop_1_proc_U0_rows_empty_n = rows37_channel_empty_n;
...
assign rows37_channel_U_ap_dummy_ce = ap_const_logic_1;
assign rows37_channel_din = image_filter_Block_proc_U0_rows_out_din;
assign rows37_channel_read = image_filter_Loop_1_proc_U0_rows_read;
assign rows37_channel_write = image_filter_Block_proc_U0_rows_out_write;
