...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = fmc_hdmi_input_axi_vdma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vtc
 PARAMETER DRIVER_VER = 6.1
 PARAMETER HW_INSTANCE = fmc_hdmi_input_v_tc_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tpg
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = fmc_hdmi_input_v_tpg_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = hdmi_output_logicvc_1
END
